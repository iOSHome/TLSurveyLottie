//
//  TLAnimationUIControlsViewController.m
//  TLSurveyLottie
//
...
- (void)viewDidLoad {
    ...
    CGSize buttonSize = [closeButton sizeThatFits:self.view.bounds.size];
    closeButton.frame = CGRectMake(10, 30, buttonSize.width, 50);
