//
//  TLAnimationKeyboardViewController.m
//  TLSurveyLottie
//
...
#import "TLAnimationKeyboardViewController.h"
#import "TLAnimatedTextField.h"

@interface TLAnimationKeyboardViewController () <UITextFieldDelegate>

@end

@implementation TLAnimationKeyboardViewController {
  TLAnimatedTextField *textField_;
...
- (void)viewDidLoad {
  ...
  textField_ = [[TLAnimatedTextField alloc] initWithFrame:self.view.bounds];
