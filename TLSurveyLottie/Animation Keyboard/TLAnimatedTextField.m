...
#import "TLAnimatedTextField.h"

@interface TLCharacterCell : UICollectionViewCell
...
@implementation TLCharacterCell {
...
@interface TLAnimatedTextField () <UICollectionViewDataSource, UICollectionViewDelegateFlowLayout>

@end

@implementation TLAnimatedTextField {
  NSString *_text;
...
- (instancetype)initWithFrame:(CGRect)frame
{
  ...
  if (self) {
    ...
    [_collectionView registerClass:[TLCharacterCell class] forCellWithReuseIdentifier:@"char"];
...
- (__kindof UICollectionViewCell *)collectionView:(UICollectionView *)collectionView
  ...
  TLCharacterCell *charCell = [collectionView dequeueReusableCellWithReuseIdentifier:@"char" forIndexPath:indexPath];
  return charCell;
}

- (void)collectionView:(UICollectionView *)collectionView
       willDisplayCell:(TLCharacterCell *)cell
